"""
PPO Training for VizDoom Deadly Corridor
Original version before tutorial optimizations

Uses standard PPO hyperparameters and RGB observations.
"""
...
def main():
    print("\n" + "="*60)
    print("PPO TRAINING - Deadly Corridor (Original)")
    print("="*60)
    ...
    agent = PPO(
        ...
        vf_coef=0.5,
        max_grad_norm=0.5,
        tensorboard_log=f"./logs/{ENV_ID}_original",
        policy_kwargs=dict(
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        save_path=f"./models/{ENV_ID}_original",
        name_prefix="ppo_corridor_original"
    )
    ...
    # Save final model
    final_path = f"./models/{ENV_ID}_original/final_model"
